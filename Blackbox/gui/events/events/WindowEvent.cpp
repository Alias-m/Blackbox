...
WindowEvent::WindowEvent():event(new internal_event::WindowEvent())
{
...
void WindowEvent::addEvent(internal_event::InternalEvent* e)
{
    internal_event::WindowEvent* tmp = dynamic_cast<internal_event::WindowEvent*>(e);
    delete event;
    event = tmp;
}

void internal_event::WindowEvent::closeEvent(Component* c, WindowListener* listener)
{
    c->close();
}
